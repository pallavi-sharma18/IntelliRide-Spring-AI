...
-- ============================================================
-- Test accounts for local end-to-end testing (password: Test@1234)
-- Login: testrider@uber.com / testdriver@uber.com
-- FK rows resolved by email so they don't depend on the generated id.
-- ============================================================
INSERT INTO app_user (name, email, password) VALUES
  ('Test Rider',  'testrider@uber.com',  '$2a$10$RCW1yvDdbrQYhBYyolc3PeYZrIaQ2OnFK25puasuq4E5d.H48nqEK'),
  ('Test Driver', 'testdriver@uber.com', '$2a$10$RCW1yvDdbrQYhBYyolc3PeYZrIaQ2OnFK25puasuq4E5d.H48nqEK');

INSERT INTO user_roles (user_id, roles)
  SELECT id, 'RIDER'  FROM app_user WHERE email = 'testrider@uber.com';
INSERT INTO user_roles (user_id, roles)
  SELECT id, 'DRIVER' FROM app_user WHERE email = 'testdriver@uber.com';

INSERT INTO rider (user_id, rating)
  SELECT id, 5.0 FROM app_user WHERE email = 'testrider@uber.com';

INSERT INTO driver (user_id, rating, available, current_location)
  SELECT id, 4.8, true, ST_GeomFromText('POINT(77.2090 28.6139)', 4326)
  FROM app_user WHERE email = 'testdriver@uber.com';

INSERT INTO wallet (user_id, balance)
  SELECT id, 1000 FROM app_user WHERE email = 'testrider@uber.com';
INSERT INTO wallet (user_id, balance)
  SELECT id, 500  FROM app_user WHERE email = 'testdriver@uber.com';